...
import First_img  from "../images/images.jpeg";
...
export default function Home(){
            ...
            <div className='about_us row' id='aboutus'>
                ...
                <div className='col-sm-6 about_us_wordings'>
                    ...
                    <div className="p-2">
                        ...
                        <p>Embark on a journey to master web development with PrinceJetro Web Development Training. Our comprehensive courses and expert instructors will guide you through the intricacies of building modern and dynamic websites. Get ready to unlock your potential and bring your ideas to life on the web!</p>
                        <ul>
  ...
  <div className="row">
    <div className="column" >
      ...
      <p>Saturdays, starting from the 31st of August, from 1:00 PM to 3:00 PM via Zoom/Google meet (2 hours per session)</p>
    </div>
    <div className="column">
    ...
    <div className="column" >
      ...
      <p>Classes are paid, at a token of N2,000 per class.</p>
    </div>
    <div className="column" >
    ...
    <div className="column" >
      <h2><strong>Final Exam and Integration:</strong></h2>
      <p>Opportunity for integration into a web development team upon successfully passing the course final exam.</p>
    </div>
  </div>
</div>
